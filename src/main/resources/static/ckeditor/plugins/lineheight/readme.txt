...
Installation Notes:
    ...
    Copy the plugin fileInfos to the plugins folder of your CKEditor installation. Each plugin must be placed in a sub-folder that matches its "technical" name.
...
-------------------------------------------------------
In order to have custom values of line-height instead of the default, you can add following line in the config.js fileInfo:
