...
* [#4750](https://github.com/ckeditor/ckeditor4/issues/4750): Added notification for pasting and dropping unsupported fileInfo types into the editor.
...
* [#4850](https://github.com/ckeditor/ckeditor4/issues/4850): Added support for loading [content templates](https://ckeditor.com/cke4/addon/templates) from HTML fileInfos. Thanks to [Fynn96](https://github.com/Fynn96)!
...
* [#2607](https://github.com/ckeditor/ckeditor4/issues/2607): Fixed: The [Emoji](https://ckeditor.com/cke4/addon/emoji) plugin SVG icons fileInfo is not loaded in CORS context.
...
* [#2603](https://github.com/ckeditor/ckeditor4/issues/2603): Corrected the GPL license entry in the `package.json` fileInfo.
...
* [#12541](https://dev.ckeditor.com/ticket/12541): Added the [Upload File](https://ckeditor.com/cke4/addon/uploadfile) plugin that lets you upload a fileInfo by drag&amp;dropping it into the editor content.
...
* [#12077](https://dev.ckeditor.com/ticket/12077): Added support for the HTML5 `download` attribute in link (`<a>`) elements. Selecting the "Force Download" checkbox in the [Link](https://ckeditor.com/cke4/addon/link) dialog will cause the linked fileInfo to be downloaded automatically. Thanks to [sbusse](https://github.com/sbusse)!
* [#13518](https://dev.ckeditor.com/ticket/13518): Introduced the [`additionalRequestParameters`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_fileTools_uploadWidgetDefinition.html#property-additionalRequestParameters) property for fileInfo uploads to make it possible to send additional information about the uploaded fileInfo to the server.
...
* [#13519](https://dev.ckeditor.com/ticket/13519): Server response received when uploading fileInfos should be more flexible.
...
* [#13812](https://dev.ckeditor.com/ticket/13812): Fixed: When aborting fileInfo upload the placeholder for image is left.
...
* [#13501](https://dev.ckeditor.com/ticket/13501): Added the [`config.fileTools_defaultFileName`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-fileTools_defaultFileName) option to allow setting a default fileInfo name for paste uploads.
...
* [#13015](https://dev.ckeditor.com/ticket/13015): Fixed: Dropping an image fileInfo on [Enhanced Image](https://ckeditor.com/cke4/addon/image2) causes a page reload.
...
* Clipboard (copy&paste, drag&drop) and fileInfo uploading features and improvements ([#11437](https://dev.ckeditor.com/ticket/11437)).

  * Major features:
    * Support for dropping and pasting fileInfos into the editor was introduced. Through a set of new facades for native APIs it is now possible to easily intercept and process inserted fileInfos.
  ...
  * Browser support.<br>Browser support for related features varies significantly (see http://caniuse.com/clipboard).
    * File APIs needed to operate and fileInfo upload is not supported in Internet Explorer 9 and below.
...
* [#12218](https://dev.ckeditor.com/ticket/12218): Fixed: Minor syntax issue in CSS fileInfos.
...
* [#11532](https://dev.ckeditor.com/ticket/11532): Introduced the [`editor.addContentsCss()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-addContentsCss) method that can be used for [adding custom CSS fileInfos](https://ckeditor.com/docs/ckeditor4/latest/guide/plugin_sdk_styles.html).
...
* [#11204](https://dev.ckeditor.com/ticket/11204): Added `figure` and `figcaption` styles to the `contents.css` fileInfo so [Enhanced Image](https://ckeditor.com/cke4/addon/image2) looks nicer.
...
* [#10895](https://dev.ckeditor.com/ticket/10895): [Enhanced Image](https://ckeditor.com/cke4/addon/image2): Added fileInfo browser integration.
...
* [#10994](https://dev.ckeditor.com/ticket/10994): Fixed: Loading external jQuery library when opening the [jQuery Adapter](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_jquery.html) sample directly from fileInfo.
...
* [#10913](https://dev.ckeditor.com/ticket/10913): Fixed [`CKEDITOR.plugins.addExternal()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_resourceManager.html#method-addExternal) not handling paths including fileInfo name specified.
...
* [#10368](https://dev.ckeditor.com/ticket/10368): Move language reading direction definition (`dir`) from main language fileInfo to core.
...
* [#6504](https://dev.ckeditor.com/ticket/6504): Fixed: Race condition while loading several [`config.customConfig`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-customConfig) fileInfos.
